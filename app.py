...
st.title("CineSense")
st.caption("Movie Review Sentiment Classifier — Bidirectional LSTM")
st.write(
    "Enter a movie review and CineSense will predict whether the "
...
if st.button("Predict Sentiment"):
    if review.strip() == "":
        ...
        predicted_sentiment = encoder.inverse_transform([predicted_class])[0]
